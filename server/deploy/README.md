...
- **alertmanager.example.yml** — маршруты по severity; примеры получателей: Slack (api_url + channel), Telegram (через webhook/пром-сервис), email. Раскомментировать нужный receiver и подставить свои URL/токены.
